...
<head>
    ...
    <style>
        table.dataTable thead {
            background: linear-gradient(to right, #783739, #783739);
            color: white;
        }
    </style>
</head>
                    ...
                    <div class="col-lg-12">
                        <table id="tablaUsuarios" class="table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td><?php echo $respuestas['documento'] ?></td>
                                        <td><?php echo $respuestas['nombre'] ?></td>
                                        <td><?php echo $respuestas['apellido'] ?></td>
                                        <td><?php echo $respuestas['correo'] ?></td>
                                        <td><?php echo $respuestas['contrasena'] ?></td>
                                        <td><?php echo $respuestas['grado'] ?></td>
                                    </tr>
                                <?php
                                }
                                ?>
